...
export class TableData extends ItemData {
	...
	private async fromTag(buffer: Buffer, tag: string, offset: number, len: number): Promise<number> {
		switch (tag) {
			...
			case 'ROTA': this.bgRotation[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'LAYB': this.bgLayback[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'INCL': this.bgInclination[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'FOVX': this.bgFov[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'SCLX': this.bgScaleX[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'SCLY': this.bgScaleY[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'SCLZ': this.bgScaleZ[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'XLTX': this.bgXlateX[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'XLTY': this.bgXlateY[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'XLTZ': this.bgXlateZ[Enums.BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'ROTF': this.bgRotation[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'LAYF': this.bgLayback[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'INCF': this.bgInclination[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'FOVF': this.bgFov[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'SCFX': this.bgScaleX[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'SCFY': this.bgScaleY[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'SCFZ': this.bgScaleZ[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'XLFX': this.bgXlateX[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'XLFY': this.bgXlateY[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'XLFZ': this.bgXlateZ[Enums.BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'ROFS': this.bgRotation[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'LAFS': this.bgLayback[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'INFS': this.bgInclination[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'FOFS': this.bgFov[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'SCXS': this.bgScaleX[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'SCYS': this.bgScaleY[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'SCZS': this.bgScaleZ[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'XLXS': this.bgXlateX[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'XLYS': this.bgXlateY[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'XLZS': this.bgXlateZ[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'EFSS':
			...
			case 'BIMG': this.bgImage[Enums.BackglassIndex.DESKTOP] = this.getString(buffer, len); break;
			case 'BIMF': this.bgImage[Enums.BackglassIndex.FULLSCREEN] = this.getString(buffer, len); break;
			case 'BIMS': this.bgImage[Enums.BackglassIndex.FULL_SINGLE_SCREEN] = this.getString(buffer, len); break;

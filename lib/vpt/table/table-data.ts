...
export class TableData extends ItemData {
	...
	private async fromTag(buffer: Buffer, tag: string, offset: number, len: number): Promise<number> {
		switch (tag) {
			...
			case 'ROTA': this.bgRotation[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'LAYB': this.bgLayback[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'INCL': this.bgInclination[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'FOVX': this.bgFov[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'SCLX': this.bgScaleX[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'SCLY': this.bgScaleY[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'SCLZ': this.bgScaleZ[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'XLTX': this.bgXlateX[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'XLTY': this.bgXlateY[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'XLTZ': this.bgXlateZ[BackglassIndex.DESKTOP] = this.getFloat(buffer); break;
			case 'ROTF': this.bgRotation[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'LAYF': this.bgLayback[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'INCF': this.bgInclination[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'FOVF': this.bgFov[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'SCFX': this.bgScaleX[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'SCFY': this.bgScaleY[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'SCFZ': this.bgScaleZ[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'XLFX': this.bgXlateX[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'XLFY': this.bgXlateY[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'XLFZ': this.bgXlateZ[BackglassIndex.FULLSCREEN] = this.getFloat(buffer); break;
			case 'ROFS': this.bgRotation[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'LAFS': this.bgLayback[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'INFS': this.bgInclination[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'FOFS': this.bgFov[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'SCXS': this.bgScaleX[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'SCYS': this.bgScaleY[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'SCZS': this.bgScaleZ[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'XLXS': this.bgXlateX[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'XLYS': this.bgXlateY[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'XLZS': this.bgXlateZ[BackglassIndex.FULL_SINGLE_SCREEN] = this.getFloat(buffer); break;
			case 'EFSS':
				this.bgEnableFss = this.getBool(buffer);
				/* istanbul ignore if: legacy */
				if (this.bgEnableFss) {
					this.bgCurrentSet = BackglassIndex.FULL_SINGLE_SCREEN;
				}
				break;
